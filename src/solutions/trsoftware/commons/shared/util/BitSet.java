 ...
 * <a href="https://github.com/gwtproject/gwt/">GWT Project on GitHub</a>
 * </p>
 *
 *
...
public class BitSet {
  ...
  private void setInternal(int fromIndex, int toIndex) {
    ...
    array = maybeGrowArrayToIndex(array, last);
  ...
  private static int[] maybeGrowArrayToIndex(int[] array, int newMaxIndex) {
    ...
    if (newLength > array.length) {
      return ArrayUtils.grow(array, newLength);
    }
    return array;
  }
  ...
  public Object clone() {
    return new BitSet(ArrayUtils.copyOf(array, array.length));
  }
  ...
  public void flip(int bitIndex) {
    ...
    array = maybeGrowArrayToIndex(array, index);
  ...
  public BitSet get(int fromIndex, int toIndex) {
    ...
    if (rightShift == 0) {
      ...
      int[] subArray = ArrayUtils.copyOfRange(array, subFrom, subTo);
  ...
  public void or(BitSet set) {
    ...
    array = maybeGrowArrayToIndex(array, set.array.length - 1);
