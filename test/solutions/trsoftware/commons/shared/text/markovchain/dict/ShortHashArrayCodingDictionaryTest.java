 ...
 * @author Alex
 */
public class ShortHashArrayCodingDictionaryTest extends TestCase {
  ShortHashArrayCodingDictionary codingDictionary;

  @Override
  protected void setUp() throws Exception {
    super.setUp();
    codingDictionary = new ShortHashArrayCodingDictionary();
  }
