...
/**
 * Copy of {@link com.google.gwt.user.server.rpc.RPCServletUtils} modified to make some members public,
 * in order to allow a different implementation of {@link #readContentAsGwtRpc(HttpServletRequest)}.
 * This might be useful if, for example, you want to limit the number of bytes read from the input stream.
 */
/*
  TODO: this code should be kept up-to-date with com.google.gwt.user.server.rpc.RPCServletUtils for any new GWT releases
  (the current version was taken from GWT 2.8.2)
*/
public class RPCServletUtils {
  ...
  /*
    NOTE(alex): CHARSET_CACHE removed to avoid duplication with com.google.gwt.user.server.rpc.RPCServletUtils.CHARSET_UTF8
   */
  ...
  public static Charset getCharset(String encoding) {
    return com.google.gwt.user.server.rpc.RPCServletUtils.getCharset(encoding);
  }

  /**
   * Returns true if the {@link Method Method} definition on
 ...
 /**
   ...
   */
  public static void checkCharacterEncodingIgnoreCase(
   ...
   */
  public static void checkContentTypeIgnoreCase(
