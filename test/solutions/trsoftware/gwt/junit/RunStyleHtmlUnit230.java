...
public class RunStyleHtmlUnit230 extends RunStyle {
  ...
  static {
    ...
    addBrowser(BrowserVersion.FIREFOX_52, "gecko1_8");  // the other possibility in HU2.30 is FIREFOX_45
    addBrowser(BrowserVersion.CHROME, "safari");
//    addBrowser(BrowserVersion.INTERNET_EXPLORER_8, "ie8");  // no longer supported in HU2.30
   ...
   */
  public RunStyleHtmlUnit230(JUnitShell shell) {
    super(shell);
  }
