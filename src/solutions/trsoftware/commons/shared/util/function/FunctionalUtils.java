...
public class FunctionalUtils {
   ...
   */
  public static <T, U, R> Function<U, R> partial(BiFunction<T, U, R> fun, T t) {
    return (u) -> fun.apply(t, u);
  }

  // TODO: create a symmetrical "partial2" method, that can be used to bind the 2nd arg instead of the 1st
