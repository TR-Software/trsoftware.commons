 ...
 *
 * <p>
 * <b>Example</b>: (do something every 3rd time through a loop, but not unil the 10th iteration)
 *
 * <pre>
 ...
 * where the modulo check will be performed in more than 1 place (encapsulates
...
public class ModuloCounter {
   ...
   * @param modulus The {@link #increment()} method will return true when the counter
   ...
   *
   * @return {@code true} if this call broke the barrier: the count is now equal
