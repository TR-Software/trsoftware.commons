 ...
 *   Copied from {@link com.google.gwt.dev.GwtVersion}, and added the factory method {@link #get()}
 * </p>
 */
public final class GwtVersion implements Comparable<GwtVersion> {
  ...
  /**
   * @return a new instance representing the return value of {@link GWT#getVersion()}
   */
  public static GwtVersion get() {
    return new GwtVersion(GWT.getVersion());
  }
}
