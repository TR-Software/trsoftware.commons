...
public class MapBuilderTest extends TestCase {
  ...
  public void testBuilder() throws Exception {
    assertEquals(newLinkedHashMap(), new MapBuilder<Integer, String>(newLinkedHashMap()).getMap());
    assertEquals(MapUtils.<Integer, String>linkedHashMap(1, "foo", 2, "bar"),
        new MapBuilder<Integer, String>(newLinkedHashMap()).put(1, "foo").put(2, "bar").getMap());
  }
