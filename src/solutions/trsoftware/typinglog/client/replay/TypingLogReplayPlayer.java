...
import solutions.trsoftware.commons.shared.text.TypingLogAnalyzer;
...
import solutions.trsoftware.gcharts.client.GoogleChartsApiLoader;
...
public class TypingLogReplayPlayer extends Composite {
  ...
  private class IncrementSpeedChart extends DestroyableComposite {
    ...
    private IncrementSpeedChart() {
      ...
      GoogleChartsApiLoader.get().loadChartsApi(new String[]{"corechart", "bar"}, new Command() {
        @Override
        public void execute() {
